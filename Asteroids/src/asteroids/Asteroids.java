...
import asteroids.objects.GameObjectFactory;
...
public class Asteroids extends JFrame {
    ...
    //+++++++++++++++++++++++++++++++++
    //objetos
    private Nave nave = (Nave)GameObjectFactory.createGameObject(GameObjectFactory.TipoGameObject.NAVE);
    private HUD hud = (HUD)GameObjectFactory.createGameObject(GameObjectFactory.TipoGameObject.HUD);
    //+++++++++++++++
    //listas de objetos
    ...
    private void disparaTiro() {
        if (temporizadorDosTiros.expirou()) {//se já pode dar um novo tiro
            GameObject novoTiro = GameObjectFactory.createGameObject(GameObjectFactory.TipoGameObject.TIRO);
            ...
            novoTiro.setAnguloDoMovimento(nave.getAnguloDoMovimento() - 90);
    ...
    private GameObject criaNovoInimigo() {
        GameObject novoInimigo = GameObjectFactory.createGameObject(GameObjectFactory.TipoGameObject.INIMIGO);
