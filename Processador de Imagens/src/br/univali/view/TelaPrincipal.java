...
import br.univali.view.processadores.Borrador;
import br.univali.view.processadores.GeradorDeCinza;
import br.univali.view.processadores.GeradorDeSepia;
import br.univali.view.processadores.FiltroNulo;
...
import br.univali.view.processadores.Filtro;
...
public class TelaPrincipal extends JFrame {
    ...
    private final Filtro filtro; // a aplicação sempre usará um processador de imagem
    ...
    public TelaPrincipal() { //construtor
        ...
        //filtro = new GeradorDeSepia(new Riscador());
        //filtro = new GeradorDeSepia(new Riscador());
        //filtro = new GeradorDeCinza(new Riscador());
        filtro = new GeradorDeSepia(new Borrador(new Riscador()));
    }
    ...
    private void atualizaPreviewDaImagem() {
        try {
            ...
            if (imagemSelecionada != null) {
                ...
                BufferedImage imagemProcessada = filtro.processa(imagemClonada);
